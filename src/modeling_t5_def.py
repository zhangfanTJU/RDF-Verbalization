...
class DefT5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        # hidden_states = hidden_states + hidden_states_k  # for one time
...
class DefT5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.encoder = DefT5Stack(encoder_config, self.shared, shared_k)
